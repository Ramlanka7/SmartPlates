...
export const routes: Routes = [
  ...
  { path: 'menu-management', loadComponent: () => import('./features/menu-management/menu-management.component').then(m => m.MenuManagementComponent) },
  ...
  { path: 'table-management', loadComponent: () => import('./features/table-management/table-management.component').then(m => m.TableManagementComponent)},
